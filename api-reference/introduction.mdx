---
title: 'Introduction'
description: 'Use the Chartbrew API and authenticate requests.'
---
...
Use the versioned Data API when you need chart-ready rows or joined dataset results. Create a key
with data access in **Team settings → API keys**, then follow the [Data API guide](/api-reference/guides/data-api).
